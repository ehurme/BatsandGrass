...
# this csv. already contains the meta data. These are not yet in the output of irek
...
#add timestamps for photos --> raw data Ireks fotos
...
swarmbdf <- mergedbdf %>% 
  ...
  mutate(meadow = recode(meadow, "Mm" = "Mill_1")) %>% 
  mutate(meadow = recode(meadow, "Mr" = "Mill_2")) %>% 
  ...
  mutate(meadow = recode(meadow, "TW1" = "Tannenhof2_1")) %>% 
  mutate(meadow = recode(meadow, "TW2" = "Tannenhof2_2")) %>% 
  mutate(meadow = recode(meadow, "TW3" = "Tannenhof2_3")) %>% 
  mutate(meadow = recode(meadow, "TS1" = "Tannenhof2_1")) %>% 
  mutate(meadow = recode(meadow, "TS2" = "Tannenhof2_2")) %>% 
  mutate(meadow = recode(meadow, "TS3" = "Tannenhof2_3")) %>% 
