...
#required:
#choose.dir 
#setwd("/Volumes/Elements/Tadarida/Tadarida-C-master/tadaridaC_src/other_inputs")
setwd('J:/Auswertung/Tadarida/Tadarida-C-master/tadaridaC_src/other_inputs')
#choose.dir <- setwd("/Volumes/LACIE SHARE/Master/MasterArbeit/Auswertung/Tadarida/Tadarida-C-master/tadaridaC_src")


#RSDB=choose.dir("Volumes/LACIE SHARE/Master/MasterArbeit/Auswertung/Tadarida/Tadarida-L-master/RSDB_sample")
RSDB= 'J:/test/RSDB_Maerz2021'
  #"/Volumes/Elements/Tadarida/Tadarida-L-master/RSDB_März2021"
#RSDB="E:/RSDB_LF"
...
GeoFilter="Baden-Wuerttemberg" #to uncomment and edit if a species filtering is necessary
...
# etidir="/Volumes/Elements/Tadarida/Tadarida-L-master/RSDB_März2021/eti" #path where labels (.eti files) are stored 
# pardir="/Volumes/Elements/Tadarida/Tadarida-L-master/RSDB_März2021/txt" #path where features (.ta files) are stored 
etidir='J:/test/RSDB_Maerz2021/eti'
pardic='J:/test/RSDB_Maerz2021/txt'
...
ListDate=list.dirs(RSDB,recursive=T)
...
colnames(SpeciesList)[4] <- GeoFilter
