...
#choose.dir->setwd
setwd("J:/Auswertung/Tadarida/Rdata")
MRF="J:/Auswertung/Tadarida/Tadarida-C-master/tadaridaC_src/Modified_randomForest.R"
VarSel=fread("J:/Auswertung/Tadarida/Tadarida-C-master/tadaridaC_src/other_inputs/VarSel.csv")
#VarSel=NA #NA if no selection of variables
SaveTemp=TRUE
#Ftabase="RSDB_sample2011_tabase3HF_sansfiltre.csv"
Ftabase="J:/Auswertung/Tadarida/Rdata/tabase3HF_Baden-Wuerttemberg.csv"
